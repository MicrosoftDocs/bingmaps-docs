...
```
https://dev.virtualearth.net/REST/v1/Routes/DistanceMatrixAsync?origins=lat0,lon0;lat1,lon1;latM,lonM&destinations=lat0,lon0;lat1,lon1;latN,longN&travelMode=travelMode&startTime=startTime&endTime=endTime&resolution=resolution&timeUnit=timeUnit&key=BingMapsKey
```
