...
>
> Bing Maps Find a Location by Address API is deprecated and has been retired for all free (Basic) account customers. Enterprise account customers can continue to use Bing Maps Find a Location by Address API until June 30th, 2028. To avoid service disruptions, all enterprise account customers using Bing Maps Find a Location by Address API will need to be updated to use Azure Maps [Get Geocoding](/rest/api/maps/search/get-geocoding) API by June 30th, 2028. For detailed migration guidance, see [Migrate Bing Maps Find a Location by Address API](/azure/azure-maps/migrate-find-location-address).
>
