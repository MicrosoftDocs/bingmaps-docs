...
|---------------|-----------|-----------------|------------|  
|`mapArea`||**Required.** Specifies the area to search for traffic incident information.|A rectangular area specified as a bounding box. The height and width of the area bounding box must not exceed 30 decimal degrees.<br /><br /> A bounding box defines an area by specifying SouthLatitude, WestLongitude, NorthLatitude, and EastLongitude values. For more information, see [Location and Area Types](../common-parameters-and-types/location-and-area-types.md).<br /><br /> **Example**: 45.219,-122.325,47.610,-122.107|  
