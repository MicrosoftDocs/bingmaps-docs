...
|`samples`|`samp`|**Required**. Specifies the number of equally-spaced elevation values to provide along a polyline path.|Integers with a value of two (2) or greater. The maximum number of samples is 1024.<br /><br /> **Example**: samples=30|
