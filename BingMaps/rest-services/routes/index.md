...
description: "This article links and describes resources for Routes API, which is used to create a route that includes two or more locations and to create routes from major roads."
ms.date: "02/28/2018"
ms.topic: "reference"
