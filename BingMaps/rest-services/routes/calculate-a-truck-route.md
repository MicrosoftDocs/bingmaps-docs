...
>
> As of 9/30/2024, the Bing Maps `Calculate a Truck Route` service no longer supports the following parameters:
>
> - `borderRestriction`
...
>
> If included in a request, these parameters will be ignored by the service.
