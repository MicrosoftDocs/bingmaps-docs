...
|RESTMetadata|REST Services|Yes<sup>3</sup>|Any time an [Imagery](../../rest-services/imagery/get-imagery-metadata.md) URL request is made to get imagery metadata that contains a map tile URI, one (1) transaction is counted.|
