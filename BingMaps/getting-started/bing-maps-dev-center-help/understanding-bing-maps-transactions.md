...
|RESTMetadata|REST Services|Yes<sup>3</sup>|Any time a [Imagery](../../rest-services/imagery/get-imagery-metadata.md) URL request is made to get imagery metadata that contains a map tile URI, one (1) transaction is counted.|
|RESTImagery-StaticMap|REST Services|Yes<sup>3</sup>|Any time a [Imagery](../../rest-services/imagery/get-a-static-map.md) URL request is made to get imagery metadata that contains a map tile URI, one (1) transaction is counted.|
|RESTImagery-StaticMapWithRoute|REST Services|Yes<sup>3</sup>|Any time a [Imagery](../../rest-services/imagery/get-a-static-map.md) URL request is made to get imagery metadata that contains a map tile URI, one (1) transaction is counted.|
...
|RESTLocations-Reverse|REST Services|Yes<sup>3</sup>|Any time a [Locations](../../rest-services/locations/find-a-location-by-point.md) URL request is made to geocode location data, one (1) transaction is counted.|
