...
|WS: CalculateRoute|SOAP Services|Yes<sup>5</sup>|Any time a request is made using the [RouteServiceClient.CalculateRoute Method](http://msdn.microsoft.com/en-us/library/cc981072.aspx) , one (1) transaction is counted.|  
