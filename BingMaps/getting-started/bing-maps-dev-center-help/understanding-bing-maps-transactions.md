...
|RESTImagery-StaticMap|REST Services|Any time a [Imagery](../../rest-services/imagery/get-a-static-map) URL request is made to get imagery metadata that contains a map tile URI, one (1) transaction is counted.|
|RESTImagery-StaticMapWithRoute|REST Services|Any time a [Imagery](../../rest-services/imagery/get-a-static-map) URL request is made to get imagery metadata that contains a map tile URI, one (1) transaction is counted.|
