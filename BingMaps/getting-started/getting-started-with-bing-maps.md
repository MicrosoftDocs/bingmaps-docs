...
To start developing with [!INCLUDE[ve_product_name](../articles/includes/ve-product-name-md.md)], choose the API(s) that is most appropriate for your platform and needs.  
...
|[Bing Maps REST Services](../rest-services/bing-maps-rest-services.md)|The [!INCLUDE[bm_rest_product_name](../articles/includes/bm-rest-product-name-md.md)] uses REST URLs to perform tasks such as creating a map with pushpins, geocoding an address, retrieving imagery metadata or calculating a route.|  
|[Bing Spatial Data Services](../spatial-data-services/bing-spatial-data-services.md)|The [!INCLUDE[bm_spatialapi_product_name](../articles/includes/bm-spatialapi-product-name-md.md)] uses REST URLs to geocode and reverse-geocode large sets of spatial data and to create and query data sources. A data source contains sets of data for a user-defined entity type that has a spatial component. For example you can create a data source for a set of stores and then query this data source to find stores near a location.|  
|[Bing Maps WPF Control](../Topic/Bing%20Maps%20WPF%20Control.md)|The Bing Maps WPF Control SDK lets developers integrate Bing Maps into rich [Windows Presentation Foundation](http://msdn.microsoft.com/en-us/library/ms754130.aspx) (WPF) applications. Using a software + services approach, the Bing Maps WPF Control retrieves the latest Bing Maps imagery for your WPF application using Bing’s cloud-based architecture. The Bing Maps WPF Control SDK also supports [Microsoft Surface](http://www.microsoft.com/surface/en/us/default.aspx) touch interface for creating rich touch-enabled applications.<br /><br /> To start using the [!INCLUDE[wpf_product_name](../getting-started/includes/wpf-product-name-md.md)], download the [Bing Maps Windows Presentation Foundation Control SDK](http://www.microsoft.com/download/en/details.aspx?id=27165).|  
...
## News and Resources  
 To keep up to date with the latest  [!INCLUDE[ve_product_name](../articles/includes/ve-product-name-md.md)] news, read the [Bing Dev Center Blog](http://blogs.bing.com/maps/). For help from the [!INCLUDE[ve_product_name](../articles/includes/ve-product-name-md.md)] community, use the [Bing Maps Forums](http://social.msdn.microsoft.com/Forums/en-US/category/bingmaps).