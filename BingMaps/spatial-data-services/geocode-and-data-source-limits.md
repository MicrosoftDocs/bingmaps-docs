...
description: Learn about account limits for a Bing Maps Account when using the Bing Spatial Data Services or Maps Dev Center to geocode entities and manage data sources. ```
ms.custom: ""
ms.date: "02/28/2018"
ms.reviewer: ""
ms.suite: ""
...
**Note:** The Bing Maps Spatial Data Services (i.e.: [Geocode Dataflow API](/bingmaps/spatial-data-services/geocode-dataflow-api) and [Data Source Management API](/bingmaps/spatial-data-services/data-source-management-api)) do not have a service level agreement (SLA) specifically for job processing completion time. However, smaller jobs will typically process faster than larger jobs. The processing completion time for each job can take up to 12 hours, generally much faster than that.
