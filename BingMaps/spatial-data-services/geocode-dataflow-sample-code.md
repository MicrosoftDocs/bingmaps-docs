...
-   The code accepts input data in any of the formats supported by the Geocode Dataflow. Examples of supported data formats are XML and CSV(comma-separated values). See [Create Job](../spatial-data-services/create-a-geocode-job-and-upload-data.md) for more information about supported data formats.  
