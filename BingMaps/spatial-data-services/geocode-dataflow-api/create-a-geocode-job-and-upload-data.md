...
-   Binary (application/octet-stream) [Specify this format when you upload compressed data from a [Blob Service REST API](https://msdn.microsoft.com/en-us/library/dd135733.aspx) location using the dataLocation parameter.]  
