...
>
> Bing Maps Spatial Data Service Geodata API is deprecated and will be retired. Free (Basic) account customers can continue to use Bing Maps Spatial Data Service Geodata API until June 30th, 2025. Enterprise account customers can continue to use Bing Maps Spatial Data Service Geodata API until June 30th, 2028. To avoid service disruptions, all implementations using Bing Maps Spatial Data Service Geodata API will need to be updated to use Azure Maps [Get Polygon](/rest/api/maps/search/get-polygon) API by the retirement date that applies to your Bing Maps for Enterprise account type. For detailed migration guidance, see [Migrate Bing Maps Geodata API](/azure/azure-maps/migrate-geodata).
>
