...
|EntityType|Geocode Response|A string specifying the `entity type` of the location.<br /><br /> For a list of entity types, see [Location and Area Types](../rest-services/location-and-area-types.md).<br /><br /> **Examples**:<br /><br /> Address<br /><br /> RoadBlock|  
