...
|EntityType|GeocodeResponse|A list of geographic `Entity Types` associated with a location, such as Address, PopulatedPlace and Neighborhood.<br /><br /> For a list of entity types, see [Location and Area Types](../rest-services/location-and-area-types.md).<br /><br /> **Example**: PopulatedPlace|  
