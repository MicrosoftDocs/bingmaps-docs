...
`fillColor`          | string _or_ [Color](Color%20Class.md)  | The color of the inside of the polygon.
`strokeColor`       | string _or_ [Color](Color%20Class.md) | The color of the polygon rings.
