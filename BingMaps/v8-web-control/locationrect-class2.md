...
------------- | ------------ | --------------------
`center`      | [Location](Location%20Class.md)     | The location that defines the center of the rectangle.
...
Method                                                              | Description
------------------------------------------------------------------- | ----------------------
fromCorners(northwest: [Location](Location%20Class.md), southeast: [Location](Location%20Class.md))             | Returns a LocationRect using the specified locations for the northwest and southeast corners.
...
fromLocations([Location](Location%20Class.md)[])                                         | Returns a LocationRect using a list of locations or an array of locations.
...
contains(location: [Location](Location%20Class.md))                         | boolean              | Determines if a Location is within the LocationRect.
...
`getNorthwest()`                     | [Location](Location%20Class.md)             | Returns the Location that defines the northwest corner of the LocationRect.
`getSouth()`                         | number               | Returns the latitude that defines the southern edge of the LocationRect.
`getSoutheast()`                     | [Location](Location%20Class.md)             | Returns the Location that defines the southeast corner of the LocationRect.
