...
* If an error occurs when searching for a boundary, the callback function will be called with a [GeoDataResultSet object](../v8-web-control/geodataresultset-object.md) whose `results` property will be an empty array.
